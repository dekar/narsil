...
const char * prompt_default = _PROMPT_DEFAUTL;
...
//*****************************************************************************
void microrl_set_execute_callback (microrl_t * this, void (*execute)(int, const char* const*))
{
...
static int microrl_insert_text (microrl_t * this, const char * text, int len)
{
